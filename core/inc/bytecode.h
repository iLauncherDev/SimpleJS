...
#define SIMPLEJS_BYTECODE_OPCODE_GET_VAR_PROP_MASK_REGS 0xFF
#define SIMPLEJS_BYTECODE_OPCODE_GET_VAR_PROP_FLAG_HAS_OUT_OBJECT_LEVEL (1 << 8)

#define SIMPLEJS_BYTECODE_OPCODE_CREATE_OBJ_VAR_FLAG_IGNORE_ARGUMENT (1 << 8)

#define SIMPLEJS_BYTECODE_OPCODE_CREATE_OBJ_VAR_MASK_OBJECT_TYPE 0xFF
#define SIMPLEJS_BYTECODE_OPCODE_CREATE_OBJ_VAR_TYPE_DYNAMIC_OBJECT 0
...
typedef enum
{
    ...
    SIMPLEJS_BYTECODE_OPCODE_SET_VAR_STD_FLAGS,
    SIMPLEJS_BYTECODE_OPCODE_CLEAR_VAR_STD_FLAGS,
    ...
    SIMPLEJS_BYTECODE_OPCODE_GET_FUNC_THIS_VAR,
    SIMPLEJS_BYTECODE_OPCODE_SET_CALL_THIS_VAR,

    SIMPLEJS_BYTECODE_OPCODE_GET_FUNC_SUPER_VAR,
    SIMPLEJS_BYTECODE_OPCODE_SET_CALL_SUPER_VAR,

    SIMPLEJS_BYTECODE_OPCODE_CREATE_OBJ_VAR, // r1 = out, r2 = argument, imm = (0-7: type) | (8:31 flags)

    SIMPLEJS_BYTECODE_OPCODE_SET_VAR_UNDEFINED,
    SIMPLEJS_BYTECODE_OPCODE_SET_VAR_NULL,
